...
<div class="col-md-12 row_dasboard-prop-listing property_wrapper_dash">
    <div class="col-md-12 dasboard-prop-listing">
        ...
        if($user_login!=$author){
            print '   <div class="dashboard_unit_author_info">'.__('by','wpestate').' '.$author.'  </div>';
        }
        ?>
        ...
        <div class="prop-info">
            ...
            <div class="info-container">
				...
				<a  id="prop_delete" data-original-title="<?php _e('Delete property','wpestate');?>" class="dashboad-tooltip" onclick="return confirm(' <?php echo __('Are you sure you want to remove your listing and cancel all bids received? ','wpestate'); ?>')" href="<?php print esc_url_raw(add_query_arg( 'delete_id', $post_id,  $_SERVER['REQUEST_URI']  ) );?>">Delete</a> 
