...
<div class="adv-search-1 <?php echo esc_html($close_class.' '.$extended_class);?>" id="adv-search-1" > 
    ...
    <form role="search" method="get"   action="<?php esc_url(print $adv_submit); ?>" >
        ...
        <div class="col-md-8">
            <input type="text" id="adv_location" class="form-control" name="adv_location"  placeholder="<?php _e('Type address, state, city or area','wpestate');?>" value="<?php
        ...
        <div class="col-md-2">
            ...
            <input name="submit" type="submit" class="wpresidence_button" id="advanced_submit_10" value="<?php _e('SEARCH','wpestate');?>">
        </div>
